...
export const SERVICES = [
  {
    ...
    desc:  'As the leading turnkey interior contractors in Chennai, we provide a seamless concept-to-keys approach. We manage everything from initial 3D design and material selection to execution and final handover, all strictly in-house.',
    startingFrom: null,
    homefixLink: null,
  },
  {
    ...
    desc:  'Looking for the best modular kitchens in Chennai? We design and install custom L-shape, U-shape, parallel, and island layouts. Built with premium marine ply carcass and finished in high-quality acrylic, laminate, or sleek PU finish.',
    startingFrom: '₹85,000',
  ...
  },
  {
    ...
    desc:  'Maximize your bedroom space with our custom floor-to-ceiling wardrobes. We specialize in modern sliding door wardrobes with smooth mechanisms, hinged units, and intelligent space-saving storage solutions tailored for Chennai homes.',
    startingFrom: '₹45,000',
  ...
  },
  {
    ...
    desc:  'Transform your living spaces with our modern media walls and floating consoles. We expertly craft and install textured fluted wall panels and stunning backlit TV units for living rooms to create the perfect entertainment center.',
    startingFrom: '₹18,000',
