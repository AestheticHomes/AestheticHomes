 ...
 * SECTIONS
 * ─────────
 * 1. Hero          — Full-viewport, headline + dual CTA + stats
 * 2. Urgency strip — Slot-count scarcity signal
 * 3. Pain/Promise  — 4 pain points flipped to 4 promises
 * 4. Services grid — 6 cards with pricing anchors
 * 5. Inline CTA    — Mid-page WhatsApp nudge
 * 6. Process       — 5-step "free until you commit" journey
 * 7. Testimonials  — 4 review cards with specifics
 * 8. Estimator CTA — Interactive estimator callout (replaces pricing table)
 * 9. Big CTA       — Full emotional close
 * 10. Areas        — 15 local SEO area badges
 * 11. FAQ          — Accordion + FAQPage JSON-LD
 *
 * SEO
 * ───
 * • H1 contains primary keyword
 * • FAQPage JSON-LD via <Seo>
...
export default function HomePage({ onNav }: Props) {
  ...
  useEffect(() => {
    const obs = new IntersectionObserver(
      (entries) => entries.forEach((e: IntersectionObserverEntry) => { if (e.isIntersecting) { e.target.classList.add('visible'); obs.unobserve(e.target) } }),
      { threshold: 0.1 }
    )
    lpRef.current?.querySelectorAll('.lp-reveal').forEach(el => obs.observe(el))
  ...
  // ── Urgency slot count (stable per day) ──
  const slots = ['2','3','3','4']
  const slotCount = slots[Math.floor(Date.now() / 86400000) % slots.length]

  const WA_VISIT  = CONTACT.waLink1
  const WA_QUOTE  = `https://wa.me/${CONTACT.phone1.replace('+','')}?text=Hi%2C%20I%27d%20like%20to%20know%20the%20cost%20for%20my%20interior%20project%20in%20Chennai`
  const WA_FINAL  = `https://wa.me/${CONTACT.phone1.replace('+','')}?text=Hi%20Aesthetic%20Homes%2C%20I%27d%20like%20a%20free%20site%20visit%20for%20my%20home%20interior%20project`

  return (
    <>
      <Seo
        title="Budget Interior Designer Chennai | 10 Years · 53 Projects"
        description={`Aesthetic Homes — Chennai's trusted budget interior designer since 2015. Modular kitchens from ₹85k, wardrobes from ₹45k, full home interiors. ${SITE.projectCount} projects, ${SITE.rating}★ rated. Free site visit. GSTIN: ${SITE.gstin}.`}
        canonical={SITE.url}
      ...
      <div className="lp" ref={lpRef}>
        ...
        <section className="lp-hero" aria-label="Hero">
          ...
          <svg className="lp-hero__arch" viewBox="0 0 500 800" fill="none" aria-hidden="true">
            ...
            <line x1="50" y1="260" x2="450" y2="260" stroke="#C8A96E" strokeWidth="0.5"/>
          </svg>
          ...
          <div className="lp-hero__content">
            ...
            <p className="lp-hero__sub">
              <b>{SITE.yearsInBiz} years. {SITE.projectCount} homes. {SITE.rating}★ across Chennai.</b><br />
            ...
            <div className="lp-hero__ctas">
              ...
              <a href={`tel:${CONTACT.phone1}`} className="lp-btn-ghost">
                ☎ {CONTACT.phone1Display}
              </a>
            </div>
            <div className="lp-hero__stats">
              <div><div className="lp-hero__stat-n">{SITE.projectCount}+</div><div className="lp-hero__stat-l">Projects Done</div></div>
              <div className="lp-hero__stat-sep" />
              <div><div className="lp-hero__stat-n">{SITE.rating}★</div><div className="lp-hero__stat-l">Google Rating</div></div>
              <div className="lp-hero__stat-sep" />
              <div><div className="lp-hero__stat-n">{SITE.yearsInBiz} Yrs</div><div className="lp-hero__stat-l">In Chennai</div></div>
              <div className="lp-hero__stat-sep" />
        ...
        <section className="lp-pain" aria-labelledby="pain-heading">
          <div className="lp-container">
            <div className="lp-section-header lp-reveal">
              ...
              <p className="lp-sub">We've heard it all — from the {SITE.projectCount} families who came to us after bad experiences elsewhere.</p>
            </div>
        ...
        <div className="lp-inline-cta">
          <p>"Not sure how much your project will cost?<br />Get a free estimate — we'll visit, measure and quote. No obligation."</p>
        ...
        <section className="lp-testimonials" aria-labelledby="testi-heading">
          <div className="lp-container">
            <div className="lp-section-header lp-reveal">
              <div className="lp-eyebrow">{SITE.reviewCount}+ Happy Families</div>
              ...
              <div className="lp-reveal lp-d2">
                <div className="lp-est-mock">
                  ...
                  <div className="lp-est-mock__body">
                    ...
                    <div className="lp-est-mock__canvas" aria-hidden="true">
                      <svg viewBox="0 0 260 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="245" y="118" textAnchor="end" fontSize="7" fill="rgba(200,169,110,0.35)" fontFamily="sans-serif">Aesthetic Homes</text>
                      </svg>
                    </div>
                ...
                <div className="lp-est-hint">↑ This is a static preview — interact with the real thing</div>
              </div>
        ...
        <section className="lp-cta" aria-labelledby="cta-heading">
          <div className="lp-container">
            <div className="lp-cta__badge">
              <span className="lp-pulse" />
              Free Site Visits Open This Week
            </div>
            ...
            <div className="lp-cta__actions lp-reveal">
              ...
              <a href={`tel:${CONTACT.phone1}`} style={{ fontSize:'0.85rem', color:'rgba(244,239,232,0.35)', textDecoration:'none' }}>
                Or call {CONTACT.phone1Display}
              </a>
            </div>
        ...
        <div className="lp-areas" role="region" aria-label="Service areas">
          ...
          <div className="lp-areas__tags">
            {SERVICE_AREAS.slice(0, 15).map(a => (
              <span key={a} className="lp-area-tag">{a}</span>
            ))}
          </div>
        </div>
            ...
            <div className="lp-faq-list" role="list">
              {HOME_FAQS.map((faq, i) => (
                ...
                >
                  ...
                  <div className="lp-faq-a" aria-hidden={openFaq !== i}>
                    {faq.a}
                  </div>
                </div>
              ))}
        ...
        <footer className="lp-footer">
          ...
          <div className="lp-footer__gstin">GSTIN {SITE.gstin} · Kodambakkam, Chennai – 600024</div>
